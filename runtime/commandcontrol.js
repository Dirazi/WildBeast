...
exports.helpHandle = function (msg, suffix) {
  ...
  if (!suffix) {
    ...
    msgArraytwo.push('For further questions, join our server: https://discord.gg/jDAJMxZ')
    msgArraytwo.push('If you are still confused, feel free to contact @Dezire#6923')
